...
namespace 
{
    ...
    const MASTER_SUGGEST_ENTRY g_aHighElfPvE[] = {
        {AT_SKILL_DurabilityReduction1, 10}, {AT_SKILL_MaximumSDincrease, 20},    {AT_SKILL_DefenseIncrease, 20},
        {AT_SKILL_TRIPLE_SHOT_STR, 20},      {AT_SKILL_TRIPLE_SHOT_MASTERY, 10},  {AT_SKILL_ATTACK_STR, 20},
        {AT_SKILL_ATTACK_MASTERY, 20},       {AT_SKILL_WeaponMasteryHighElf, 20}, {AT_SKILL_ICE_ARROW_STR, 20},
        {AT_SKILL_BowStrengthener, 20},      {AT_SKILL_BowMastery, 10},           {AT_SKILL_INFINITY_ARROW_STR, 20},
        {AT_SKILL_MinimumAttPowerInc, 20},
    };

    const MASTER_SUGGEST_ENTRY g_aHighElfPvP[] = {
        {AT_SKILL_PvPDefenceRateInc, 20},     {AT_SKILL_MaximumSDincrease, 20},
        {AT_SKILL_SdRecoverySpeedInc, 20},    {AT_SKILL_DefenseIncrease, 20},
        {AT_SKILL_DefenseSuccessRateInc, 20}, {AT_SKILL_DEFENSE_STR, 20},
        {AT_SKILL_DEFENSE_MASTERY, 20},       {AT_SKILL_ATTACK_STR, 20},
        {AT_SKILL_ATTACK_MASTERY, 20},        {AT_SKILL_WeaponMasteryHighElf, 20},
        {AT_SKILL_PvPAttackRate, 20},         {AT_SKILL_CrossbowStrengthener, 20},
        {AT_SKILL_CrossbowMastery, 20},       {AT_SKILL_INFINITY_ARROW_STR, 20},
        {AT_SKILL_MinimumAttPowerInc, 20},
    };

    const MASTER_SUGGEST_ENTRY g_aHighElfSupport[] = {
        {AT_SKILL_HEALING_STR, 20},          {AT_SKILL_DEFENSE_STR, 20},
        {AT_SKILL_DEFENSE_MASTERY, 20},      {AT_SKILL_ATTACK_STR, 20},
        {AT_SKILL_SummonedMonsterStr1, 20},  {AT_SKILL_SummonedMonsterStr2, 20},
        {AT_SKILL_AutomaticManaRecInc, 20},  {AT_SKILL_MaximumSDincrease, 20},
        {AT_SKILL_DefenseIncrease, 20},      {AT_SKILL_ShieldStrengthenerHighElf, 20},
        {AT_SKILL_ShieldMasteryHighElf, 20},
    };

    const MASTER_SUGGEST_ENTRY g_aDimensionMasterPvE[] = {
        {AT_SKILL_DurabilityReduction1, 10}, {AT_SKILL_MaximumSDincrease, 20},
        {AT_SKILL_AutomaticManaRecInc, 20},  {AT_SKILL_DefenseIncrease, 20},
        {AT_SKILL_LIGHTNING_SHOCK_STR, 20},  {AT_SKILL_ALICE_CHAINLIGHTNING_STR, 20},
        {AT_SKILL_MagicMasterySummoner, 20}, {AT_SKILL_LightningTomeStren, 20},
        {AT_SKILL_LightningTomeMastery, 20}, {AT_SKILL_StickStrengthener, 20},
        {AT_SKILL_StickMastery, 20},         {AT_SKILL_ALICE_BERSERKER_STR, 20},
        {AT_SKILL_BerserkerProficiency, 20}, {AT_SKILL_MinimumWizCurseInc, 20},
    };

    const MASTER_SUGGEST_ENTRY g_aDimensionMasterPvP[] = {
        {AT_SKILL_PvPDefenceRateInc, 20},    {AT_SKILL_MaximumSDincrease, 20},     {AT_SKILL_SdRecoverySpeedInc, 20},
        {AT_SKILL_DefenseIncrease, 20},      {AT_SKILL_DefenseSuccessRateInc, 20}, {AT_SKILL_ALICE_SLEEP_STR, 20},
        {AT_SKILL_LIGHTNING_SHOCK_STR, 20},  {AT_SKILL_MagicMasterySummoner, 20},  {AT_SKILL_ALICE_DRAINLIFE_STR, 20},
        {AT_SKILL_OtherWorldTomeStreng, 20}, {AT_SKILL_OtherWorldTomeMastery, 10}, {AT_SKILL_ALICE_BERSERKER_STR, 20},
        {AT_SKILL_BerserkerProficiency, 20}, {AT_SKILL_MinimumWizCurseInc, 20},
    };
    ...
    const MASTER_SUGGEST_ENTRY g_aDuelMasterPvP[] = {
        {AT_SKILL_PvPDefenceRateInc, 20},     {AT_SKILL_MaximumSDincrease, 20},
        {AT_SKILL_SdRecoverySpeedInc, 20},    {AT_SKILL_DefenseIncrease, 20},
        {AT_SKILL_DefenseSuccessRateInc, 20}, {AT_SKILL_POWER_SLASH_STR, 20},
        {AT_SKILL_TWISTING_SLASH_STR_MG, 20}, {AT_SKILL_WeaponMasteryDuelMaster, 20},
        {AT_SKILL_EVIL_SPIRIT_STR_MG, 20},    {AT_SKILL_MagicMasteryDuelMaster, 20},
        {AT_SKILL_FIRE_SLASH_STR, 20},
    };

    const MASTER_SUGGEST_ENTRY g_aLordEmperorPvE[] = {
        {AT_SKILL_DurabilityReduction1, 10}, {AT_SKILL_MaximumSDincrease, 20},        {AT_SKILL_DefenseIncrease, 20},
        {AT_SKILL_FIREBURST_STR, 20},        {AT_SKILL_FIREBURST_MASTERY, 20},        {AT_SKILL_EARTHSHAKE_STR, 20},
        {AT_SKILL_EARTHSHAKE_MASTERY, 20},   {AT_SKILL_WeaponMasteryLordEmperor, 20}, {AT_SKILL_FIRE_SCREAM_STR, 20},
        {AT_SKILL_ScepterStrengthener, 20},  {AT_SKILL_ScepterMastery, 20},           {AT_SKILL_CommandAttackInc, 20},
        {AT_SKILL_DarkSpiritStr, 20},        {AT_SKILL_DarkSpiritStr2, 20},           {AT_SKILL_DarkSpiritStr3, 20},
    };
    ...
    const MASTER_SUGGEST_ENTRY g_aTempleKnightPvP[] = {
        {AT_SKILL_IncreasePvPDefenseRate, 20},     {AT_SKILL_IncreaseMaximumSd, 20},
        {AT_SKILL_IncreaseSdRecoveryRate, 20},     {AT_SKILL_IncreasesDefense, 20},
        {AT_SKILL_IncreaseDefenseSuccessRate, 20}, {AT_SKILL_BEAST_UPPERCUT_STR, 20},
        {AT_SKILL_BEAST_UPPERCUT_MASTERY, 20},     {AT_SKILL_IncreaseMaximumHp, 20},
        {AT_SKILL_WeaponMasteryFistMaster, 20},    {AT_SKILL_IncreasePvPAttackRate, 20},
        {AT_SKILL_DEF_UP_OURFORCES_STR, 20},       {AT_SKILL_DEF_UP_OURFORCES_MASTERY, 20},
        {AT_SKILL_HP_UP_OURFORCES_STR, 20},        {AT_SKILL_IncreaseMinimumAttackPower, 20},
    };
...
bool SEASON3B::CNewUIMasterLevel::EnsureRequirements(const _MASTER_SKILLTREE_DATA& skillData, int& freePoints,
                                                     int depth)
{
...
void SEASON3B::CNewUIMasterLevel::SpendSuggestedPoints(ActionSkillType skill, int targetLevel, int& freePoints,
                                                       int depth)
{
...
void SEASON3B::CNewUIMasterLevel::ApplySuggestedPoints()
{
    ...
    for (const auto& entry : this->m_vSuggestPoint)
    {
        ...
        SocketClient->ToGameServer()->SendAddMasterSkillPointMultiple(static_cast<uint16_t>(entry.SkillNumber),
                                                                      static_cast<BYTE>(entry.Points));
    }
